 ...
 * @method ServiceCategory setStoreId()    Sets the current record's "store_id" value
 * @method ServiceCategory setServiceId()  Sets the current record's "service_id" value
 * @method ServiceCategory setStore()      Sets the current record's "Store" value
 * @method ServiceCategory setService()    Sets the current record's "Service" value
 * 
 * @package    qhawpay
 * @subpackage model
 ...
 */
abstract class BaseServiceCategory extends DoctrineRecord
{
